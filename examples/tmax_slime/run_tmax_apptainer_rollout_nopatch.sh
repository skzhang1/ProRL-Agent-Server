#!/usr/bin/env bash
# Container-side launcher for TMax PI trajectory rollout without runtime patching.
...
ensure_current_checkouts
log "No-patch mode: using Polar, Slime, Megatron, and SGLang exactly as found"
prepare_prompt_data_and_sifs
prepare_agent_cli
ensure_checkpoint
prepare_reference_checkpoint_compat
